<!-- Prima Versione: Stampiamo i dischi solo con l’utilizzo di PHP, che stampa direttamente i dischi in pagina:
...
<head>
    ...
    <script type="text/javascript" src="../firstVersion/script.js" defer></script>
</head>
